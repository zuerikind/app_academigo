export const de = {
  ...
  teacher: {
    ...
    dashboard: {
      ...
      deactivatedBanner:
        "Dein Konto ist inaktiv. Du bist für Lernende nicht mehr sichtbar. Bitte kontaktiere den Support, falls du glaubst, dass dies ein Fehler ist.",
      reviewBanner:
  ...
  lessons: {
    ...
    weekdays: ["Montag", "Dienstag", "Mittwoch", "Donnerstag", "Freitag", "Samstag", "Sonntag"] as const,
